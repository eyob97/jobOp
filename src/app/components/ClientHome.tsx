  ...
  return (
    <>
      {user ? (
        ...
        <>
          <SignInPage /> {/* Display the Signin component when user is not authenticated */}
          <Header />
          <div
                ...
                <div className="row mb-5">
                  <div className="col-sm-4">
                    ...
                    <p className="hiw-text">
                      Sign up in seconds using your mobile number. Start your
                  ...
                  <div className="col-sm-4">
                    ...
                    <p className="hiw-text">
                      Get personalized job alerts directly through WhatsApp based
