...
const defaultAuthConfig = {
  ...
  signInUrl: "https://jobop.co.za/recruitment/sign-in/",
  signUpUrl: "https://jobop.co.za/recruitment/sign-up/",
  signUpVerificationUrl:
    "https://jobop.co.za/recruitment/sign-up-verification/",
  tokenRefreshUrl: "api/auth/refresh",
  getUserUrl: "https://jobop.co.za/recruitment/user/",
...
>(
...
): JwtAuth<User, SignInPayload, SignUpPayload, SignUpVerificationPayload> => {
   ...
   */
  const signUpVerification = useCallback((data: SignUpVerificationPayload) => {
    const response = axios.post(authConfig.signUpVerificationUrl, data);
    response.then(
      (res: AxiosResponse<{ user: User; access_token: string }>) => {
        const userData = res?.data?.user;
        const accessToken = res?.data?.access_token;
